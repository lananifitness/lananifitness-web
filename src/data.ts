...
export const BLOG_POSTS: PostBlog[] = [
  ...
  },
  {
    ...
    contenido: [
      ...
      'Lunes: avena con leche de avena, canela y arándanos de desayuno. De comida, salmón al horno con verduras asadas y arroz integral. Y de cena, una crema de calabaza con pan integral tostado.',
      'Martes: yogur natural con nueces y miel de desayuno. De comida, pechuga de pollo a la plancha con ensalada de espinacas y aguacate. Y de cena, una tortilla de verduras con ensalada verde.',
      'Miércoles: tostadas de pan integral con aceite de oliva y tomate de desayuno. De comida, lentejas con zanahoria y apio. Y de cena, merluza al vapor con brócoli y un toque de limón.',
      'Jueves: batido de plátano, espinacas y leche de almendras de desayuno. De comida, arroz integral con verduras salteadas y huevo pochado. Y de cena, sopa de pollo con verduras.',
      'Viernes: tostadas con aguacate y huevo revuelto de desayuno. De comida, sardinas al horno con patata cocida y ensalada. Y de cena, crema de zanahoria con semillas de lino.',
      'Sábado: yogur natural con fresas y semillas de chía de desayuno. De comida, pollo al horno con boniato y judías verdes. Y de cena, ensalada de atún con garbanzos y pepino.',
      'Domingo: porridge de avena con manzana y canela de desayuno. De comida, merluza con arroz y verduras al vapor. Y de cena, crema de puerros con pan integral.',
  ...
  },
  {
    ...
    contenido: [
      ...
      'Lunes: huevos revueltos con tostada integral y zumo de naranja de desayuno. De comida, pechuga de pollo a la plancha con quinoa y espinacas. Y de cena, salmón al horno con patata cocida y ensalada verde.',
      'Martes: yogur griego con nueces, plátano y semillas de chía de desayuno. De comida, lentejas con arroz integral y zanahoria. Y de cena, una tortilla de 3 huevos con verduras salteadas.',
      'Miércoles: porridge de avena con leche entera y almendras de desayuno. De comida, merluza al horno con brócoli y arroz integral. Y de cena, pavo a la plancha con ensalada de garbanzos.',
      'Jueves: tostadas con aguacate, huevo pochado y tomate de desayuno. De comida, ternera magra a la plancha con patata al horno y judías verdes. Y de cena, crema de lentejas con pan integral tostado.',
      'Viernes: batido de leche, plátano, avena y mantequilla de cacahuete de desayuno. De comida, atún fresco a la plancha con quinoa y verduras asadas. Y de cena, revuelto de huevos con espinacas y queso fresco.',
      'Sábado: yogur griego con frutos rojos y granola sin azúcar de desayuno. De comida, pollo al horno con boniato y brócoli. Y de cena, sardinas a la plancha con ensalada de garbanzos y pepino.',
      'Domingo: tortita de avena con huevo y plátano de desayuno. De comida, salmón con arroz integral y espárragos. Y de cena, sopa de pollo con verduras y fideos integrales.',
  ...
  },
  {
    ...
    contenido: [
      ...
      'Lunes: avena con leche de avena, plátano y semillas de chía de desayuno. De comida, salmón al horno con arroz integral y espinacas. Y de cena, crema de calabaza con semillas de calabaza tostadas.',
      'Martes: yogur griego con frutos rojos y nueces de desayuno. De comida, pechuga de pavo con quinoa y brócoli al vapor. Y de cena, tortilla de huevos con espinacas y queso fresco.',
      'Miércoles: tostadas integrales con aguacate y huevo pochado de desayuno. De comida, lentejas con zanahoria, apio y cúrcuma. Y de cena, merluza al vapor con patata cocida y ensalada verde.',
      'Jueves: batido de plátano, leche de almendras, cacao puro y avena de desayuno. De comida, pollo al horno con boniato y judías verdes. Y de cena, sopa de verduras con fideos integrales.',
      'Viernes: porridge de avena con manzana, canela y almendras de desayuno. De comida, atún fresco a la plancha con arroz integral y espárragos. Y de cena, revuelto de huevos con champiñones y tostada integral.',
      'Sábado: yogur griego con plátano, miel y semillas de lino de desayuno. De comida, sardinas al horno con patata y ensalada de pepino. Y de cena, crema de brócoli con queso fresco y pan integral.',
      'Domingo: tostadas con mantequilla de almendras y plátano de desayuno. De comida, salmón con quinoa y verduras asadas. Y de cena, sopa de pollo con verduras y arroz integral.',
