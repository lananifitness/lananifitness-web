...
export const BLOG_POSTS: PostBlog[] = [
  ...
  },
  {
    ...
    contenido: [
      ...
      'Lunes||Desayuno: avena con leche de avena, canela y arándanos.||Comida: salmón al horno con verduras asadas y arroz integral.||Cena: crema de calabaza con pan integral tostado.',
      'Martes||Desayuno: yogur natural con nueces y miel.||Comida: pechuga de pollo a la plancha con ensalada de espinacas y aguacate.||Cena: tortilla de verduras con ensalada verde.',
      'Miércoles||Desayuno: tostadas de pan integral con aceite de oliva y tomate.||Comida: lentejas con zanahoria y apio.||Cena: merluza al vapor con brócoli y un toque de limón.',
      'Jueves||Desayuno: batido de plátano, espinacas y leche de almendras.||Comida: arroz integral con verduras salteadas y huevo pochado.||Cena: sopa de pollo con verduras.',
      'Viernes||Desayuno: tostadas con aguacate y huevo revuelto.||Comida: sardinas al horno con patata cocida y ensalada.||Cena: crema de zanahoria con semillas de lino.',
      'Sábado||Desayuno: yogur natural con fresas y semillas de chía.||Comida: pollo al horno con boniato y judías verdes.||Cena: ensalada de atún con garbanzos y pepino.',
      'Domingo||Desayuno: porridge de avena con manzana y canela.||Comida: merluza con arroz y verduras al vapor.||Cena: crema de puerros con pan integral.',
  ...
  },
  {
    ...
    contenido: [
      ...
      'Lunes||Desayuno: huevos revueltos con tostada integral y zumo de naranja.||Comida: pechuga de pollo a la plancha con quinoa y espinacas.||Cena: salmón al horno con patata cocida y ensalada verde.',
      'Martes||Desayuno: yogur griego con nueces, plátano y semillas de chía.||Comida: lentejas con arroz integral y zanahoria.||Cena: tortilla de 3 huevos con verduras salteadas.',
      'Miércoles||Desayuno: porridge de avena con leche entera y almendras.||Comida: merluza al horno con brócoli y arroz integral.||Cena: pavo a la plancha con ensalada de garbanzos.',
      'Jueves||Desayuno: tostadas con aguacate, huevo pochado y tomate.||Comida: ternera magra a la plancha con patata al horno y judías verdes.||Cena: crema de lentejas con pan integral tostado.',
      'Viernes||Desayuno: batido de leche, plátano, avena y mantequilla de cacahuete.||Comida: atún fresco a la plancha con quinoa y verduras asadas.||Cena: revuelto de huevos con espinacas y queso fresco.',
      'Sábado||Desayuno: yogur griego con frutos rojos y granola sin azúcar.||Comida: pollo al horno con boniato y brócoli.||Cena: sardinas a la plancha con ensalada de garbanzos y pepino.',
      'Domingo||Desayuno: tortita de avena con huevo y plátano.||Comida: salmón con arroz integral y espárragos.||Cena: sopa de pollo con verduras y fideos integrales.',
  ...
  },
  {
    ...
    contenido: [
      ...
      'Lunes||Desayuno: avena con leche de avena, plátano y semillas de chía.||Comida: salmón al horno con arroz integral y espinacas.||Cena: crema de calabaza con semillas de calabaza tostadas.',
      'Martes||Desayuno: yogur griego con frutos rojos y nueces.||Comida: pechuga de pavo con quinoa y brócoli al vapor.||Cena: tortilla de huevos con espinacas y queso fresco.',
      'Miércoles||Desayuno: tostadas integrales con aguacate y huevo pochado.||Comida: lentejas con zanahoria, apio y cúrcuma.||Cena: merluza al vapor con patata cocida y ensalada verde.',
      'Jueves||Desayuno: batido de plátano, leche de almendras, cacao puro y avena.||Comida: pollo al horno con boniato y judías verdes.||Cena: sopa de verduras con fideos integrales.',
      'Viernes||Desayuno: porridge de avena con manzana, canela y almendras.||Comida: atún fresco a la plancha con arroz integral y espárragos.||Cena: revuelto de huevos con champiñones y tostada integral.',
      'Sábado||Desayuno: yogur griego con plátano, miel y semillas de lino.||Comida: sardinas al horno con patata y ensalada de pepino.||Cena: crema de brócoli con queso fresco y pan integral.',
      'Domingo||Desayuno: tostadas con mantequilla de almendras y plátano.||Comida: salmón con quinoa y verduras asadas.||Cena: sopa de pollo con verduras y arroz integral.',
...
export const SEO_PAGINAS: Record<string, SeoMeta> = {
  ...
  blog: {
    title: 'Blog de La Nani Fitness — Rutinas, comida y motivación',
    description: 'Artículos sobre rutinas, alimentación, motivación y comunidad para mujeres +60 que quieren cuidarse.',
    path: '/blog',
  },
  contacto: {
